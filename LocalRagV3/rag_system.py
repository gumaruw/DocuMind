        ...
        if contents["texts"]:
            ...
            for text in contents["texts"]:
                ...
                for sentence in sentences:
                    ...
                    # (önceki hali tanımsız bir "sentence_lower" değişkenine
                    # bakıyordu ve bu satıra her girildiğinde NameError
                    # fırlatıyordu)
                    if any(keyword in sentence_keywords for keyword in question_keywords):
